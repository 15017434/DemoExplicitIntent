    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvSuperman.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                //Start the activity with requestedCodeForSupermanStats to
                //identify it was started by clicking Superman
        ...
        tvBatman.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                //Start the activity with requestedCodeForSupermanStats to
                //identify it was started by clicking Batman
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if(resultCode == RESULT_OK){
            if(data != null){
                ...
                //If 2nd activity started by clicking Batman, create corresponding String
